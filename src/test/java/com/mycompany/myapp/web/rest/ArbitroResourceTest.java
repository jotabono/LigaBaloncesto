...
public class ArbitroResourceTest {
    ...
    private static final String DEFAULT_NOMBRE_ARBITRO = "AAAAA";
    private static final String UPDATED_NOMBRE_ARBITRO = "BBBBB";
    ...
    public void initTest() {
        arbitro = new Arbitro();
        arbitro.setNombreArbitro(DEFAULT_NOMBRE_ARBITRO);
    }
    ...
    public void createArbitro() throws Exception {
        ...
        assertThat(testArbitro.getNombreArbitro()).isEqualTo(DEFAULT_NOMBRE_ARBITRO);
    }
    ...
    public void getAllArbitros() throws Exception {
        ...
        restArbitroMockMvc.perform(get("/api/arbitros"))
                ...
                .andExpect(jsonPath("$.[*].nombreArbitro").value(hasItem(DEFAULT_NOMBRE_ARBITRO.toString())));
    }
    ...
    public void getArbitro() throws Exception {
        ...
        restArbitroMockMvc.perform(get("/api/arbitros/{id}", arbitro.getId()))
            ...
            .andExpect(jsonPath("$.nombreArbitro").value(DEFAULT_NOMBRE_ARBITRO.toString()));
    }
    ...
    public void updateArbitro() throws Exception {
        ...
        // Update the arbitro
        arbitro.setNombreArbitro(UPDATED_NOMBRE_ARBITRO);
        ...
        Arbitro testArbitro = arbitros.get(arbitros.size() - 1);
        assertThat(testArbitro.getNombreArbitro()).isEqualTo(UPDATED_NOMBRE_ARBITRO);
    }
