...
public class LigaResourceTest {
    ...
    private static final String DEFAULT_NOMBRE_LIGA = "AAAAA";
    private static final String UPDATED_NOMBRE_LIGA = "BBBBB";
    ...
    public void initTest() {
        liga = new Liga();
        liga.setNombreLiga(DEFAULT_NOMBRE_LIGA);
    }
    ...
    public void createLiga() throws Exception {
        ...
        assertThat(testLiga.getNombreLiga()).isEqualTo(DEFAULT_NOMBRE_LIGA);
    }
    ...
    public void getAllLigas() throws Exception {
        ...
        restLigaMockMvc.perform(get("/api/ligas"))
                ...
                .andExpect(jsonPath("$.[*].nombreLiga").value(hasItem(DEFAULT_NOMBRE_LIGA.toString())));
    }
    ...
    public void getLiga() throws Exception {
        ...
        restLigaMockMvc.perform(get("/api/ligas/{id}", liga.getId()))
            ...
            .andExpect(jsonPath("$.nombreLiga").value(DEFAULT_NOMBRE_LIGA.toString()));
    }
    ...
    public void updateLiga() throws Exception {
        ...
        // Update the liga
        liga.setNombreLiga(UPDATED_NOMBRE_LIGA);
        ...
        Liga testLiga = ligas.get(ligas.size() - 1);
        assertThat(testLiga.getNombreLiga()).isEqualTo(UPDATED_NOMBRE_LIGA);
    }
